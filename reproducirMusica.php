...
echo'<div class="TotalCenter" id="Acceso1" style="font-size: 1.3rem;" onclick="maximizar()">
  <b class="space">Space</b>
  <b class="songs">Songs<b>
</div>';

echo'<div class="TotalCenter" id="Acceso2" onclick="maximizar()">'. $Musica['nombre'] .' - '. $Musica['autor'] .'</div>';
